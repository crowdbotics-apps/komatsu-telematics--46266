"""
Django settings for komatsu_telematics__46266 project.
...
ROOT_URLCONF = 'komatsu_telematics__46266.urls'
...
WSGI_APPLICATION = 'komatsu_telematics__46266.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "komatsu_telematics__46266 API",
    "DESCRIPTION": "API documentation for komatsu_telematics__46266 App",
    "VERSION": "v1",
}
